...
.header-logo {
  ...
  <p>Client Name: ${reportData.clientName || "Unknown Client"}</p>
...
function generateEntriesPages(entries) {
    const PAGE_SIZE = 30; // entries per page
    let pagesHTML = "";
    ...
    for (let pageIndex = 0; pageIndex < totalPages; pageIndex++) {
        ...
        const groupEntries = entries.slice(startIndex, startIndex + PAGE_SIZE);
